...
--Tom Brown not included because his det_id NULL
...
--Tom Brown will appear in the results, but the dept_dept and dept_name columns will have NULL values, because he doesn't have a department.
...
INNER JOIN departments d
    ON e.dept_id = d.dept_id
   AND d.location = 'Building A';
--the same result only employees whose depatment Building A
